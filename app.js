...
var addButton=document.getElementById("addBtn");//first button
...
var createNewTaskElement=function(taskString){
  ...
  editButton.className="button task-edit";

  deleteButton.className="button task-delete";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("todo__item_active");
  ...
  listItem.classList.toggle("todo__item_active");
};
